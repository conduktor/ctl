...
For the server TLS authentication, you can either ignore the certificate by setting CDK_INSECURE=true, or provide your own certificate authority using CDK_CACERT.`,
